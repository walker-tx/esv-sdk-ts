 ...
 *
 * @see {@link https://api.esv.org/docs/passage-audio/} - Esv.org API Docs for `/v3/passage/audio`
 */
export function passagesGetAudio(
  client: EsvCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetPassageAudioRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/passage/audio/")();
